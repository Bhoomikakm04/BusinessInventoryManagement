...
"""
Business Inventory Dashboard - Full (fixed LLM prompt)

This is the fixed version of business_inventory_dashboard_full.py with the escaped triple-quote issue corrected.
Save as app.py for Streamlit Cloud or run locally with streamlit run business_inventory_dashboard_full_fixed.py
"""
...
st.set_page_config(page_title="AIC Inventory - Full (Fixed)", layout="wide", initial_sidebar_state="expanded")
...
Given product name: {chosen_product} and customer reviews, recommend a single short inventory or product action (examples: 'Halt restock', 'Investigate quality', 'Increase safety stock', 'No action').
Reviews:\n{sample_reviews}"""
